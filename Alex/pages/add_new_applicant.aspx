<%@ Page Title="" Language="C#" MasterPageFile="~/pages/master.Master" AutoEventWireup="true" CodeBehind="add_new_applicant.aspx.cs" Inherits="Alex.pages.add_new_applicant" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10 h1">Search For Profiles To Add Applicant</div>
    </div>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <asp:GridView ID="GridViewAddNewApplicant" runat="server" AutoGenerateColumns="False"
            CssClass="table table-striped table-bordered table-hover dataTables-example" OnRowDataBound="GridViewAddNewApplicant_RowDataBound">
            <Columns>

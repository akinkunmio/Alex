<%@ Page Title="" Language="C#" MasterPageFile="~/pages/master.Master" AutoEventWireup="true" CodeBehind="boarder_feepay.aspx.cs" Inherits="Alex.pages.boarder_feepay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-3 pull-right">
       <br /><asp:Button runat="server" ID="btnOK" CssClass="fa fa-arrow-circle-left btn btn-sm btn-info m-t-n-xs" Text="&nbsp;Back to Account(s) Summary" OnClick="Result_Click" CausesValidation="False" />
    </div>
     
    <div id="divDetails" class="row" runat="server">
        <div class="col-lg-6">
            <h1>Boarder Fee Details</h1>
            <asp:DetailsView ID="DetailsViewPayment" runat="server" Height="50px" Width="400px" CssClass="table table-striped table-bordered table-hover dataTables-example" AutoGenerateRows="False">
                <Fields>
                    ...
                    <asp:BoundField DataField="Fees" HeaderText="Boarder Fees" ReadOnly="True"></asp:BoundField>
                    <asp:BoundField DataField="Total" HeaderText="Total Boarder Fees Paid" ReadOnly="True"></asp:BoundField>
                    <asp:BoundField DataField="SBalance" HeaderText="Boarder Balance" ReadOnly="True"></asp:BoundField>
    ...
    <div id="DivToPrint" class="wrapper wrapper-content animated fadeInRight" runat="server" visible="false">
    ...
    </style><asp:Label runat="server" ID="lblSmsSchoolName" Visible="false"></asp:Label>
</asp:Content>

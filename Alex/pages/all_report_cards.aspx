    ...
    <div class="wrapper wrapper-content fadeInRight">
        <div id="divStudents" runat="server" class="row">
            ...
            <div class="col-lg-12">
                ...
                <%--Joe Column 1--%>
                <div class="col-md-3">
                    <h3><a href="student_reports/report_cards.aspx">Student Statistics</a></h3>
                    <p>
                        Student Report Card 1 (Report Cards for the school pupils by class)
                    </p>

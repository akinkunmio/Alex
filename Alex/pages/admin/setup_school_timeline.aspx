<%@ Page Title="" Language="C#" MasterPageFile="~/pages/master.Master" AutoEventWireup="true" CodeBehind="setup_school_timeline.aspx.cs" Inherits="Alex.pages.admin.setup_school_timeline" %>
...
<h1>List of Current Term School Calendar</h1>
        <asp:GridView ID="GridViewTimeLine" runat="server" AutoGenerateColumns="False"  CssClass="table table-striped table-bordered table-hover dataTables-example" 
            ...
            <Columns>
                 <asp:BoundField DataField="cal_id" HeaderText="Calender Id" ReadOnly="true" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden">

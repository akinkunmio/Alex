<%@ Page Title="" Language="C#" MasterPageFile="~/pages/master.Master" AutoEventWireup="true" CodeBehind="item_pay.aspx.cs" Inherits="Alex.pages.item_pay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-3 pull-right">
        <br />
        <asp:Button runat="server" ID="Button1" CssClass="fa fa-arrow-circle-left btn btn-sm btn-info m-t-n-xs" Text="&nbsp;Back to Item(s) Summary" OnClick="Result_Click" CausesValidation="False" />
    </div>
    ...
    <asp:DetailsView ID="DetailsViewPayment" runat="server" Height="50px" Width="400px" CssClass="table table-striped table-bordered table-hover dataTables-example" AutoGenerateRows="False">
        <Fields>
            ...
            <asp:BoundField DataField="Price" HeaderText="Total Price Due" ReadOnly="True"></asp:BoundField>
            <asp:BoundField DataField="TotalPaid" HeaderText="Total Paid" ReadOnly="True"></asp:BoundField>
                    ...
                    <div class="row">
                        ...
                        <div id="divPayInfo" runat="server" class="col-lg-6">
                            ...
                            <asp:DetailsView ID="DetailsViewPaymentInfo" runat="server" Height="50px" Width="400px" CssClass="table table-striped table-bordered table-hover dataTables-example" AutoGenerateRows="False">
                                <Fields>
                                    <asp:BoundField DataField="Amount_Paid#" HeaderText="Amount Paid now" ReadOnly="True"></asp:BoundField>
                                    <asp:BoundField DataField="receipt_no" HeaderText="Receipt No" ReadOnly="True"></asp:BoundField>

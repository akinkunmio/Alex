...
{
    public partial class employees_payslip : System.Web.UI.Page
    {
        int lvl = 0; 
        ...
        private MyStuDataSet GetData()
        {
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["conStr"].ConnectionString))
                try
                {
                    using (SqlCommand cmd = new SqlCommand("sp_ms_hr_list_all_employee_payslip", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            ...
                            dt.Tables["sp_ms_hr_list_all_employee_payslip"].Clear();
                            sda.Fill(dt.Tables["sp_ms_hr_list_all_employee_payslip"]);
                        }
                    }
        ...
        private void Info()
        {
            ...
            RptViewerPayslipAll.LocalReport.ReportPath = Server.MapPath("~/Report/Payslips.rdlc");
            MyStuDataSet dsEmployees = GetData();
            ReportDataSource datasource = new ReportDataSource("MyStuDataSet", dsEmployees.Tables[0]);

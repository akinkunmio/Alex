...
{
    public partial class boarder_feepay : System.Web.UI.Page
    {
                        ...
                        sda.SelectCommand = cmd;
                        {
                            ...
                            var query = from r in dt.AsEnumerable()
                                        ...
                                        select new
                                        {
                                            ...
                                            Fees = r["SBoarder_Fees"].ToString(),
                                            Total = r["Boarder_Fees_Total_Amount_Paid"].ToString(),
                                            SBalance = "₦" + r["Boarder_Balance"].ToString(),
        ...
        public void PaymentInfo()
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("sp_ms_person_boarder_fee_paid_reference", con);
        ...
        public void SaveFeeInfo(string Regid, string Amount, string CreatedBy)
        {
            ...
            try
            {
                using (SqlCommand cmd = new SqlCommand("sp_ms_boarder_payments_add", con))
                {
                    con.Open();
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@reg_id", SqlDbType.VarChar).Value = Regid;
                ...
                if (FeeSmstStatus == "Enabled")
                {
                    if (AvaliableSms >= 1)
                    {
                        string smsUrl = "http://www.smsmobile24.com/index.php?option=com_spc&comm=spc_api&username=" + "kandula" + "&password=" + "LOndon4321$.cop" + "&sender=" + lblSmsSchoolName.Text + "&recipient=" + "234" + lblPhoneNumber.Text + "&message=" +
                            ...
                            "Dear Parent, Thank you for the payment of N" + ReplaceAmount + " for " + DetailsViewPayment.Rows[0].Cells[1].Text + "." + "The Balance of your school fees is " + DetailsViewPayment1.Rows[3].Cells[1].Text.Replace("₦", string.Empty);
        ...
        private void SaveSmsLog()
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter() { ParameterName = "message", Value = "Dear Parent, Thanks for your payment of N" + ReplaceAmount + "." + "The Balance of your school fees is " + DetailsViewPayment1.Rows[3].Cells[1].Text.Replace("₦", string.Empty) });

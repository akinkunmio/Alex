...
<%--    <div class="col-md-3 pull-right">
    ...
    <h2>Create Assessments for a Class</h2>
    <div class=" wrapper-content  animated fadeInRight">
        <div class="col-lg-12" id="left">
            <div class="ibox">
                <div role="form" id="form">
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="pull-right">
                            <asp:RequiredFieldValidator ID="rfvddlFormClass" ErrorMessage="Class Required" ForeColor="Red" ControlToValidate="ddlFormClass"
                                runat="server" Dispaly="Dynamic" />
                        </div>
            ...
            <asp:Button ID="BtnSearchAvailSub" runat="server" Text="GO" CssClass="btn btn-sm btn-primary m-t-n-xs" Font-Bold="True" OnClick="BtnSearchAvailSub_Click" />
        </div>
        <div class="row">

            <div class="col-lg-6" id="divCreateSubjects" runat="server" visible="false">
                <h2>Avaliable Assessments for a class</h2>
                ...
                <asp:Button ID="btnCreateAssessments" runat="server" Text="Create" CssClass="btn btn-primary" OnClick="btnCreateAssessments_Click" OnClientClick="return Validate_Checkbox()" />
            </div>
            ...
            <div class="col-lg-6" id="divListAssessments" runat="server" visible="false">
                ...
                <%-- <div class="ibox">
                    <div class=" col-lg-4">
                        ...
                        <asp:DropDownList ID="ddlListAssessmentType" runat="server"></asp:DropDownList>
                    </div>
                    <div class="col-lg-2">
                        <label>Class</label><br />
                        <asp:DropDownList ID="ddlListFormClass" runat="server"></asp:DropDownList>
                    </div>
                    <br />
                    <asp:Button ID="btnSearchListAssessmnetTYpe" runat="server" Text="GO" type="search" CssClass="btn-primary" CausesValidation="False" OnClick="btnSearchListAssessmnetTYpe_Click" />
                </div>--%>

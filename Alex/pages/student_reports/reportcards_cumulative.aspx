<%@ Page Title="" Language="C#" MasterPageFile="~/pages/master.Master" AutoEventWireup="true" CodeBehind="reportcards_cumulative.aspx.cs" Inherits="Alex.pages.student_reports.reportcards_cumulative" %>
    ...
    <div id="form1" runat="server">
        <div class="row wrapper white-bg">
            <div class="col-lg-9 h1">
                Student Reports: <small>Cumulative Report Sheet</small>
            </div>
            <div class="col-md-2 ">
                <a href="../reports.aspx">
                    <br />
            ...
            <div class="ibox-content p-xl" style="height: 1000px; width: 1050px">
                ...
                <div>
                    ...
                    <rsweb:ReportViewer ID="RptViewerRptCard" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana"
                        ...
                        <LocalReport ReportEmbeddedResource="Alex.Report\RptCards_Cumulative.rdlc" ReportPath="Report\RptCards_Cumulative.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="MyStuDataSet" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="Alex.MyStuDataSetTableAdapters.sp_ms_report_card_cumulative_classTableAdapter"></asp:ObjectDataSource>
                </div>
            </div>

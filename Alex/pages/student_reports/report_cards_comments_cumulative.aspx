<%@ Page Title="" Language="C#" MasterPageFile="~/pages/master.Master" AutoEventWireup="true" CodeBehind="report_cards_comments_cumulative.aspx.cs" Inherits="Alex.pages.student_reports.report_cards_comments_cumulative" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="ibox-content p-xl" style="height: 1000px; width: 1050px">
                ...
                <div>
                    ...
                    <rsweb:ReportViewer ID="RptViewerRptCard" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana"
                        ...
                        <LocalReport ReportEmbeddedResource="Alex.Report\ReportCards_StudentsCumulative.rdlc" ReportPath="Report\ReportCards_StudentsCumulative.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="MyStuDataSet" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="Alex.MyStuDataSetTableAdapters.sp_ms_person_assessment_breakdown_cum_v7TableAdapter"></asp:ObjectDataSource>
    ...
    <asp:Label ID="lblFindClassSection" runat="server" Text="" Visible="false"></asp:Label>
</asp:Content>

...
{
    public partial class reportcards_cumulative : System.Web.UI.Page
    {
        ...
        private MyStuDataSet GetData()
        {
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ConnectionString))
                try
                {
                    ...
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@ay_term_id", 1104);
                        cmd.Parameters.AddWithValue("@class", ddlFormClass.SelectedItem.Text);
        ...
        private MyStuDataSet GetCumulative()
        {
            MyStuDataSet dt = new MyStuDataSet();
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ConnectionString))
                try
                {
                    using (SqlCommand cmd = new SqlCommand("sp_ms_report_card_cumulative_class", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                      
                        cmd.Parameters.AddWithValue("@form_class", ddlFormClass.SelectedItem.Text);
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            con.Open();
                            cmd.Connection = con;
                            ...
                            dt.sp_ms_person_report_card_nursery_assessment_all_v4.Clear();
                            dt.EnforceConstraints = false;
                            sda.Fill(dt.Tables["sp_ms_report_card_cumulative_class"]);
                        }
                    }
        ...
        private void Info()
        {
            ...
            RptViewerRptCard.LocalReport.ReportPath = Server.MapPath("~/Report/RptCards_Cumulative.rdlc");
            ...
            MyStuDataSet dsCm = GetCumulative();
            ...
            ReportDataSource datasource6 = new ReportDataSource("CumulativeDataSet", dsCm.Tables[19]);
            ReportDataSource datasource7 = new ReportDataSource("RatingsDataSet", dsNurseryRatings.Tables[17]);
        ...
        private void NurseryReportBind()
        {
            ...
            ReportDataSource datasource7 = new ReportDataSource("CumulativeDataSet", dsCm.Tables[19]);
            RptViewerRptCard.LocalReport.DataSources.Clear();
            RptViewerRptCard.LocalReport.DataSources.Add(datasource);
            RptViewerRptCard.LocalReport.DataSources.Add(datasource2);
            RptViewerRptCard.LocalReport.DataSources.Add(datasource3);

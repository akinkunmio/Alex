...
{
    public partial class mid_term_report_cards_no_pos : System.Web.UI.Page
    {
        ...
        private void Info()
        {
            ...
            RptViewerRptCard.LocalReport.ReportPath = Server.MapPath("~/Report/Mid_Term_ReportCards_Students_No_Pos.rdlc");
        ...
        {
            RptViewerRptCard.ProcessingMode = ProcessingMode.Local;
            RptViewerRptCard.LocalReport.ReportPath = Server.MapPath("~/Report/Mid_Term_ReportCards_Nursery.rdlc");
            MyStuDataSet dsAssessment1 = GetData();
            MyStuDataSet dsAssessment2 = GetAssessement2Data();
            MyStuDataSet dsAttendance = GetAttendanceData();
            MyStuDataSet dsTotals = GetTotalsData();

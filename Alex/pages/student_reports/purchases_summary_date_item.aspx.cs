...
{
    public partial class purchases_summary_date_item : System.Web.UI.Page
    {
        int lvl = 0;
        ...
        private void Purchases()
        {
            ...
            try
            {
                using (SqlCommand cmd = new SqlCommand("sp_ms_purchases_payments_filtered_by_date_item", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;

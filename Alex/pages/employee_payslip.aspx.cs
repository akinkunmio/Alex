...
namespace Alex.pages
{
    public partial class employee_payslip : System.Web.UI.Page
    {
                ...
                try
                {
                    using (SqlCommand cmd = new SqlCommand("sp_ms_hr_employee_payroll_payslip", con))
                    {
                        ...
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            ...
                            sda.Fill(dt.Tables["sp_ms_hr_employee_payroll_payslip"]);
                        }
                    }
        ...
        private void Info()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("../Report/Employee_Payslip.rdlc");
            // ReportViewer1.LocalReport.ReportPath = Server.MapPath("../Report/EmployeePayslip.rdlc");
            MyStuDataSet dsCustomers = GetData();
            ReportDataSource datasource = new ReportDataSource("MyStuDataSet", dsCustomers.Tables[1]);

<%@ Page Title="" Language="C#" MasterPageFile="~/pages/master.Master" AutoEventWireup="true" CodeBehind="purchases_summary_date_item.aspx.cs" Inherits="Alex.pages.student_reports.purchases_summary_date_item" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row wrapper white-bg">
        <div class="col-lg-9 h1">
           Accounts (Sales): <small>Sold Items  Summary</small>
        </div>
        <div class="col-md-2 ">
            <a href="../reports.aspx">
                <br />
                ...
                <div class="ibox-content p-xl">
                    ...
                    <asp:GridView ID="GridViewPurchases" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Purchase_Date1" HeaderText="Purchase Date" />
                             <asp:BoundField DataField="payment_method_ref" HeaderText="Payment Reference" />
                            <asp:BoundField DataField="quantity" HeaderText="Quantity" />
                            <asp:BoundField DataField="price" HeaderText="Price" />
                            <asp:BoundField DataField="Total Price Due" HeaderText="Total Price Due" />

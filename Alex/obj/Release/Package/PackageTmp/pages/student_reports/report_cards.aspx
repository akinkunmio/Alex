<%@ Page Title="" Language="C#" MasterPageFile="~/pages/master.Master" AutoEventWireup="true" CodeBehind="report_cards.aspx.cs" Inherits="Alex.pages.student_reports.report_cards" %>
            ...
            <div class="ibox-content p-xl" style="height: 1000px; width: 1050px">
                ...
                <div>
                    ...
                    <rsweb:ReportViewer ID="RptViewerRptCard" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana"
                        ...
                        <LocalReport ReportEmbeddedResource="Alex.Report\ReportCards_Students.rdlc" ReportPath="Report\ReportCards_Students.rdlc">
                            <DataSources>

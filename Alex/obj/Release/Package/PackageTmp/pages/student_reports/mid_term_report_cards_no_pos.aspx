<%@ Page Title="" Language="C#" MasterPageFile="~/pages/master.Master" AutoEventWireup="true" CodeBehind="mid_term_report_cards_no_pos.aspx.cs" Inherits="Alex.pages.student_reports.mid_term_report_cards_no_pos" %>
            ...
            <div class="ibox-content p-xl" style="height: 1000px; width: 1050px">
                ...
                <div>
                    ...
                    <rsweb:ReportViewer ID="RptViewerRptCard" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana"
                        ...
                        <LocalReport ReportEmbeddedResource="Alex.Report\Mid_Term_ReportCards_Students_No_Pos.rdlc" ReportPath="Report\Mid_Term_ReportCards_Students_No_Pos.rdlc">
                            <DataSources>

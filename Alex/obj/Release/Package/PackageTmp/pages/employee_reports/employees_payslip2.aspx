<%@ Page Title="" Language="C#" MasterPageFile="~/pages/master.Master" AutoEventWireup="true" CodeBehind="employees_payslip2.aspx.cs" Inherits="Alex.pages.employee_reports.employees_payslip2" %>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <br />
            <rsweb:ReportViewer ID="RptViewerPayslipAll" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana"
               ...
               <LocalReport ReportEmbeddedResource="Alex.Report\Payslips2.rdlc" ReportPath="Report\Payslips2.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDSPayslip" runat="server" SelectMethod="GetData"
                TypeName="Alex.MyStuDataSetTableAdapters.sp_ms_hr_bab_list_all_employee_payslipTableAdapter"></asp:ObjectDataSource>
            <br />
        </div>
